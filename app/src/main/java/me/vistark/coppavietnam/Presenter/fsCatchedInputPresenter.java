...
import me.vistark.coppavietnam.Presenter.fsAdapter.fsCatchedPreviewAdapter;
...
import me.vistark.coppavietnam.View.fsSaveSuccessfulActivity;
        ...
        if (takePictureIntent.resolveActivity(mContext.getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(mContext,
                        "me.vistark.coppavietnam.fileprovider",
                        photoFile);
